...
class DemandeForm(forms.ModelForm):
    ...
    nombre_passagers = forms.IntegerField(
        ...
        max_value=20,
        initial=1,
        help_text="Indiquez le nombre total de passagers (y compris vous-même)."
    )
    ...
    class Meta:
        model = Course
        fields = ['point_embarquement', 'destination', 'motif', 'date_souhaitee', 'nombre_passagers', 'commentaires']
